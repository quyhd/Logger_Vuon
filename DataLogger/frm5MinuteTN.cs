...
{
    public partial class frm5MinuteTN : Form
    {
        ...
        public frm5MinuteTN(data_value obj, LanguageService _lang)
        {
            InitializeComponent();
            obj_data_value = obj;
            //res_man = obj_res_man;
        ...
        private void frm5MinuteTN_Load(object sender, EventArgs e)
        {
